...
export default function ApurementLayout() {
  ...
  // (InventaireApurement.tsx via l'onglet "travail", ApurementCorrections.tsx via l'onglet
  // "cartes-dechargees"), qui dispatchent désormais 'app:data-updated' après chaque correction
  // réussie — même bug que celui corrigé sur AgentQualiteLayout.tsx (dirtyCartesCount/
  // conformeCartesCount/detailedSyncStats, qui pilotent le bouton "Envoyer les corrections", ne
  // se recalculaient jamais après une correction). silent=true : pas d'overlay de chargement
  // pour un événement de fond (même pattern qu'AgentQualiteLayout.tsx).
  useEffect(() => {
