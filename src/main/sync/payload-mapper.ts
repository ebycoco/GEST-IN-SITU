...
export function mapCardPayload(c: any): any {
  ...
  return {
    ...
    apurement_correction_par: c.apurement_correction_par || null, apurement_correction_le: c.apurement_correction_le || null,
    apurement_correction_motif: c.apurement_correction_motif || null,
    apurement_annulation_par: c.apurement_annulation_par || null, apurement_annulation_le: c.apurement_annulation_le || null,
